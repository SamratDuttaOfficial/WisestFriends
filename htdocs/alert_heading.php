    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <br>        
				...
				<br>        
        <small style="font-family:courier,'new courier';" class="text-muted">Your alert post can be seen by anyone from your college.</small><br>            
       ...
       <hr style= "color:#000">
       <form method="post" action="view_alerts.php" enctype="multipart/form-data">       
